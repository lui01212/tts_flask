...
def hello_world():
    ...
    """
    command_tts = f'cd /home/buivanluyn/content2/vietTTS; python3 -m vietTTS.synthesizer --lexicon-file assets/infore/lexicon.txt --text="bùi văn luyn" --output=clip.wav --silence-duration 0.2'
